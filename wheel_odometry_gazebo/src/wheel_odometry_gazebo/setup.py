...
package_name = 'wheel_odometry_gazebo'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'publish_wheel_odometry_gazebo = wheel_odometry_gazebo.publish_wheel_odometry_gazebo:main'
        ],
    },
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/publish_wheel_odometry_gazebo_launch.py']),
    ],
)
