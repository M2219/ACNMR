...
namespace ORB_SLAM3_Wrapper
{
    ...
    public:
        ...
        bool trackStereoi(const sensor_msgs::msg::Image::SharedPtr msgL, const sensor_msgs::msg::Image::SharedPtr msgR, Sophus::SE3f &Tcw);

        bool trackStereo(const sensor_msgs::msg::Image::SharedPtr msgL, const sensor_msgs::msg::Image::SharedPtr msgR, Sophus::SE3f &Tcw);
    ...
    private:
        ...
        queue<sensor_msgs::msg::Imu::SharedPtr> imuBuf_temp_;
        std::mutex bufMutex_;
