...
#---------------------------------------------
    ...
    #Essential_paths
    orb_wrapper_pkg = get_package_share_directory('orbslam3')
#---------------------------------------------
...
#---------------------------------------------
    ...
    def all_nodes_launch(context, robot_namespace, robot_x, robot_y):
        ...
        vocabulary_file_path = "/root/ACNMR/orbslam_ws/src/orbslam3_ros2/vocabulary/ORBvoc.txt"
        config_file_path = "/root/ACNMR/orbslam_ws/src/orbslam3_ros2/config/stereo-inertial/depthai_info_imu.yaml"
        declare_params_file_cmd = DeclareLaunchArgument(
            'params_file',
            default_value=os.path.join(orb_wrapper_pkg, 'params', 'stereo-inertial-ros-params.yaml'),
