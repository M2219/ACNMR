...
#---------------------------------------------
    ...
    def all_nodes_launch(context, robot_namespace, robot_x, robot_y):
        ...
        config_file_path = "/root/ACNMR/orbslam_ws/src/orbslam3_ros2/config/stereo/depthai_info.yaml"
        declare_params_file_cmd = DeclareLaunchArgument(
            'params_file',
            default_value=os.path.join(orb_wrapper_pkg, 'params', 'stereo-ros-params.yaml'),
